...
if (!class_exists('SS_Shipping_WC')) :
    ...
    class SS_Shipping_WC
    {
        ...
        private function define_constants()
        {
            ...
            $this->define('SS_SHIPPING_WOO_BLOCK_DATA_KEY_NAME', 'selectedPickupPoint');
        ...
        protected function init_hooks()
        {
             ...
             */
            add_action('block_categories_all', array($this, 'register_smart_send_block_category'), 10, 2);
        }
         ...
         * Registers the slug as a block category with WordPress.
         */
        public   function register_smart_send_block_category($categories)
        {
            return array_merge(
                $categories,
                [
